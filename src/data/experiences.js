const experiences = [
    ...
    },
    {
        ...
        title: "DOTA Drafter",
        linkName: "repo",
        link: "https://github.com/jSunpayco/dota_drafter",
        year: "Nov 2022",
    ...
    },
    {
        ...
        description: "Being motivated to create a more personalized platform to help me track my job applications, I decieded to develop a job tracker app that allows me to give me a summary of my journey in looking for a job in Software Development. As of now, both client and server side components are required to be run locally. However, progress can be found in the links provided. The frontend is seen to be developed with React Typescript wherein user interfaces display the user's job applications, allow them to update the status of each job, as well as create and delete jobs from their list. The backend on the other hand, is being developed with .Net C#, whilst AWS services like DynamoDB and Cognito have also been implemented to avail services such as storage and authentication.",
