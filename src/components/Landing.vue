  ...
  <div class="sectionContainer">
    <div class=" sticky top-32">
      ...
      <div class="flex justify-center space-x-2 mt-7">
        ...
        <a href="https://www.linkedin.com/in/julian-rafael-sunpayco-b4365222a/" class="iconAnchor">
          <!-- Linkedin -->
        ...
        <a href="https://github.com/jSunpayco" class="iconAnchor">
          <!-- GitHub -->
        ...
        <a href="/#contact" class="iconAnchor">
          <!-- Mail -->
